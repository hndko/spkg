    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-6">
                        <h5>Manajemen Akun Pengguna</h5>
                    </div>
                    <div class="col-sm-6">
                        <span class="float-right"><a href="<?= base_url('admin/users/add') ?>" class="btn btn-sm btn-primary">Tambah Data</a></span>
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-sm-12">
                                ...
                                <tbody>
                                    <?php foreach ($row->result() as $key => $user) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url() ?>admin/users/edit/<?= $user->id_user ?>" class="btn btn-sm btn-warning"><i class="icon-paper"></i></a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
