    ...
    <div class="container-scroller">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo" href="<?= site_url('guru/beranda') ?>"><img src="<?= base_url() ?>assets/templates/images/logo.svg" alt="logo" /></a>
                <a class="navbar-brand brand-logo-mini" href="<?= site_url('guru/beranda') ?>"><img src="<?= base_url() ?>assets/templates/images/logo-mini.svg" alt="logo" /></a>
            </div>
                ...
                <ul class="navbar-nav navbar-nav-right">
                    <li class="nav-item dropdown d-flex mr-4 ">
                        ...
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
                            ...
                            <a href="<?= site_url('guru/profile') ?>" class="dropdown-item preview-item">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?= site_url('guru/beranda') ?>">
                            <i class="icon-box menu-icon"></i>
                            <span class="menu-title">Beranda</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= site_url('guru/dokumenpendukung') ?>">
                            <i class="icon-folder menu-icon"></i>
                            <span class="menu-title">Dokumen Pendukung</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= site_url('guru/penilaian') ?>">
