<div class="row flex-grow">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-3 text-center">
                                <img src="<?= base_url() . 'assets/images/obj/admin.png' ?>" alt="vvv" style="width: 70%;">
                            </div>
                            <div class="col-sm-9">
                                <h3 class="card-title">Selamat Datang!</h3>
                                <p>Sistem Penilaian Kinerja Guru MTs Darwata Majenang</p>
                                <h4 class="text-dark font-weight-bold mb-2">Kepala Madrasah</h4>
                            </div>
                        </div>
            ...
            <div class="col-sm-4 mt-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p>Update data <?= date('d/m/y') ?></p>
                        <h4 class="text-dark font-weight-bold mb-2">3 <small>Orang</small></h4>
                    </div>
                </div>
            </div>
            <div class="col-sm-4 mt-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p>Update data <?= date('d/m/y') ?></p>
                        <h4 class="text-dark font-weight-bold mb-2">2 <small>Orang</small></h4>
                    </div>
                </div>
            </div>
            <div class="col-sm-4 mt-3">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Kinerja Terbaik</h4>
                        <p>Update data <?= date('d/m/y') ?></p>
                        <h4 class="text-dark font-weight-bold mb-2">2 <small>Orang</small></h4>
                    </div>
                </div>
    ...
    <div class="col-sm-4 grid-margin-lg-0 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-3">Penilaian Kinerja</h4>
                <div class="d-flex">
                    <div>
                ...
                <p class="mb-4">Based on 200 reviews</p>
                <div class="row">
                    <div class="col-sm-2 pr-0">
                        <div class="d-flex">
                            <div>
                                <div class="text-dark font-weight-bold mb-2 mr-2">A</div>
                            </div>
                            <div>
                ...
                <div class="row mt-2">
                    <div class="col-sm-2 pr-0">
                        <div class="d-flex">
                            <div>
                                <div class="text-dark font-weight-bold mb-2 mr-2">B</div>
                            </div>
                            <div>
                                <i class="fa fa-star text-warning"></i>
                            </div>
                ...
                <div class="row mt-2">
                    <div class="col-sm-2 pr-0">
                        <div class="d-flex">
                            <div>
                                <div class="text-dark font-weight-bold mb-2 mr-2">C</div>
                            </div>
                            <div>
                                <i class="fa fa-star text-warning"></i>
                            </div>
                ...
                <div class="row mt-2">
                    <div class="col-sm-2 pr-0">
                        <div class="d-flex">
                            <div>
                                <div class="text-dark font-weight-bold mb-2 mr-2">D</div>
                            </div>
                            <div>
                                <i class="fa fa-star text-warning"></i>
                            </div>
